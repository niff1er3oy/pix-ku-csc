...
export const th = {
  ...
  studio: {
    ...
    formStartsAt: "วันเวลาที่เริ่ม",
    formEndsAt: "วันเวลาที่จบ",
    formUnlisted: "ไม่แสดงในรายการงานสาธารณะ",
    formUnlistedHint: "เข้าได้เฉพาะคนที่มีลิงก์หรือ QR",
    formAccessCode: "รหัสเข้างาน",
    formAccessCodeHint: "เว้นว่างไว้ถ้าไม่ต้องใช้รหัส",
    formSave: "บันทึก",
...
export const en: Dictionary = {
  ...
  studio: {
    ...
    formStartsAt: "Starts",
    formEndsAt: "Ends",
    formUnlisted: "Hide from the public event list",
    formUnlistedHint: "Only people with the link or QR can open it",
    formAccessCode: "Access code",
    formAccessCodeHint: "Leave empty for no code",
    formSave: "Save",
