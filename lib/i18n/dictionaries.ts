...
export const th = {
  ...
  search: {
    ...
    errorNoSavedFace: "ยังไม่ได้บันทึกรูปหน้าไว้ ไปที่โปรไฟล์เพื่อบันทึกก่อน",
  },
  ...
  studio: {
    ...
    formCover: "รูปปกงาน",
    formCoverChoose: "เลือกไฟล์",
    formCoverClear: "ยกเลิกรูปนี้",
    formCoverHint:
      "JPEG, PNG หรือ WebP ไม่เกิน 5 MB สัดส่วน 1:1 (ระบบจะครอปให้อัตโนมัติ) · ไม่ใส่ก็ได้ ระบบจะใช้รูปแรกที่อัปโหลดแทน",
    formErrorCoverTooLarge: "รูปปกใหญ่เกินไป ใช้ไฟล์ที่เล็กกว่า 5 MB",
    ...
    formAllowDownloadHint:
      "ปิดไว้แล้วผู้ชมจะกดโหลดรูปไม่ได้ — เจ้าของงานเปิดดู/โหลดเองได้เสมอ",
    ...
    formStatusArchived: "พักไว้ชั่วคราวโดยคุณ กดเปิดอีกครั้งได้ทุกเมื่อ",
    formCreate: "สร้างงาน",
    ...
    eventCreatedAt: "สร้างเมื่อ {date}",
    ...
    settingsInfoLede: "ชื่อ รายละเอียด และรูปปกที่แสดงบนหน้างาน",
    ...
    pauseEventHint:
      "ปิดไม่ให้ค้นหาหรือเปิดดูได้ชั่วคราว โดยไม่ต้องรอผู้ดูแลอนุมัติใหม่ตอนเปิดกลับ รูปและข้อมูลทั้งหมดยังอยู่ครบ",
    resumeEvent: "เปิดงานอีกครั้ง",
    ...
    watermarkLogoCurrent: "ใช้โลโก้ที่อัปโหลดไว้อยู่",
    watermarkLogoHint: "PNG พื้นหลังโปร่งใส ไม่เกิน 3 MB",
    watermarkRemoveLogo: "ลบโลโก้นี้",
    watermarkErrorLogoTooLarge: "โลโก้ใหญ่เกิน 3 MB",
    watermarkErrorLogoBadFormat: "โลโก้ต้องเป็นไฟล์ PNG เท่านั้น",
    watermarkErrorEmpty:
      "เปิดใช้ลายน้ำไว้ แต่ยังไม่ได้ใส่ข้อความหรือโลโก้ — ใส่อย่างน้อยหนึ่งอย่าง ไม่งั้นรูปที่โหลดจะไม่มีลายน้ำจริง ๆ",
    watermarkPosition: "ตำแหน่ง",
    watermarkOpacity: "ความทึบ",
    watermarkScale: "ขนาด",
    watermarkPreview: "ตัวอย่าง",
    watermarkSave: "บันทึกลายน้ำ",
    watermarkPositions: {
    ...
    uploadHint: "JPEG, PNG หรือ WebP ไม่เกิน 5 MB ต่อไฟล์ อัปโหลดพร้อมกันได้หลายไฟล์",
    ...
    facesFilterActive: "กำลังกรองตามใบหน้า {id}",
    facesFilterClear: "แสดงรูปทั้งหมด",
    viewProfile: "ดูโปรไฟล์ของ {name}",
    searchesTitle: "ผู้ค้นหาในงานนี้",
    searchesAnonymous: "ไม่ระบุตัวตน",
    searchesMatchCount: "พบ {count} รูปที่ตรงกัน",
    searchesNoMatch: "ไม่พบรูปที่ตรงกัน",
    searchesViewAll: "ดูรูปที่ตรงกันทั้งหมด",
    searchesFilterActive: "กำลังกรองตามการค้นหาของ {name}",
    downloadersTitle: "ผู้ดาวน์โหลดในงานนี้",
    downloadersCount: "ดาวน์โหลดแล้ว {count} รูป",
    downloadersViewAll: "ดูรูปที่ดาวน์โหลด",
    downloadersFilterActive: "กำลังกรองตามการดาวน์โหลดของ {name}",
    ...
    photoStatusIndexed: "{count} ใบหน้า",
...
export const en: Dictionary = {
  ...
  search: {
    ...
    errorNoSavedFace: "You haven't saved a face yet — save one on your profile first.",
  },
  ...
  studio: {
    ...
    formCoverChoose: "Choose file",
    formCoverClear: "Remove",
    formCoverHint:
      "JPEG, PNG or WebP, up to 5 MB, 1:1 (cropped automatically). Optional — the first uploaded photo is used otherwise.",
    formErrorCoverTooLarge: "That cover is too large. Use a file under 5 MB.",
    ...
    formAllowDownloadHint:
      "Turned off, visitors cannot download at all. The owner can always view and download their own event.",
    ...
    formStatusArchived: "Paused by you — resume anytime",
    ...
    settingsInfoLede: "Name, description, and the cover shown on the event page",
    settingsAccessTitle: "Privacy and entry PIN",
    settingsDownloadTitle: "Downloads",
    pauseTitle: "Open / close",
    pauseEvent: "Pause event",
    pauseEventHint:
      "Temporarily hides it from search and its public page, with no admin approval needed to reopen it. Photos and settings stay exactly as they are.",
    ...
    watermarkLogoCurrent: "Currently using an uploaded logo",
    watermarkLogoHint: "Transparent PNG, up to 3 MB",
    watermarkRemoveLogo: "Remove this logo",
    watermarkErrorLogoTooLarge: "Logo is over 3 MB",
    watermarkErrorLogoBadFormat: "Logo must be a PNG file",
    watermarkErrorEmpty:
      "Watermarking is on, but there's no text or logo yet — add at least one, or downloads won't actually show a mark.",
    watermarkPosition: "Position",
    watermarkOpacity: "Opacity",
    watermarkScale: "Size",
    watermarkPreview: "Preview",
    watermarkSave: "Save watermark",
    watermarkPositions: {
    ...
    uploadHint: "JPEG, PNG or WebP, up to 5 MB each. Upload as many at once as you like.",
    ...
    facesFilterActive: "Filtering by face {id}",
    facesFilterClear: "Show all photos",
    viewProfile: "View {name}'s profile",
    searchesTitle: "Searches for this event",
    searchesAnonymous: "Anonymous",
    searchesMatchCount: "{count} photos matched",
    searchesNoMatch: "No match found",
    searchesViewAll: "View all matches",
    searchesFilterActive: "Filtering by {name}'s search",
    downloadersTitle: "Downloads for this event",
    downloadersCount: "{count} photos downloaded",
    downloadersViewAll: "View downloaded photos",
    downloadersFilterActive: "Filtering by {name}'s downloads",
    ...
    photoStatusIndexed: "{count} faces",
