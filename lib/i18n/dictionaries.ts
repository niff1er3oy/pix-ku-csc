...
export const th = {
  ...
  studio: {
    ...
    formAllowDownloadHint:
      "ปิดไว้แล้วผู้ชมจะกดโหลดรูปไม่ได้เลย (ต่อให้ตั้งลายน้ำไว้ก็ตาม) — เจ้าของงานเปิดดู/โหลดเองได้เสมอ",
...
export const en: Dictionary = {
  ...
  studio: {
    ...
    formAllowDownloadHint:
      "Turned off, visitors cannot download at all — even with a watermark. The owner can always view and download their own event.",
