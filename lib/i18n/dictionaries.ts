...
export const th = {
  ...
  studio: {
    ...
    personSearchLabel: "ค้นหารายชื่อ",
    personSearchPlaceholder: "ค้นหาชื่อ…",
    personSearchEmpty: "ไม่พบชื่อที่ตรงกับ \"{query}\"",
  ...
  admin: {
    ...
    reviewSearchPlaceholder: "พิมพ์ชื่อ…",
    reviewSearchEmpty: "ไม่พบรายการที่ตรงกับ \"{query}\"",
    approve: "อนุมัติ",
    reject: "ไม่อนุมัติ",
  ...
  affiliationsPage: {
    ...
    eventCount: "{count} งาน",
    createdLabel: "ก่อตั้งเมื่อ {date}",
    membersEmpty: "ยังไม่มีสมาชิกในสังกัดนี้",
  },

  affiliationStudio: {
    title: "สตูดิโอสังกัด",
    lede: "งานที่สร้างในสตูดิโอนี้ให้สมาชิกทุกคนในสังกัดจัดการร่วมกันได้เต็มที่",
    settingsTitle: "ตั้งค่าสังกัด",
    renameLabel: "ชื่อสังกัด",
    renameSubmit: "บันทึก",
    renameErrorInvalid: "กรอกชื่อสังกัดให้ถูกต้อง",
    renameErrorImageTooLarge: "ไฟล์รูปใหญ่เกินไป (สูงสุด 5 MB)",
    renameErrorImageBadFormat: "รองรับเฉพาะไฟล์ JPEG, PNG หรือ WebP",
    imageLabel: "รูปโปรไฟล์สังกัด",
    imageChoose: "เลือกรูป",
    imageHint: "สมาชิกในสังกัดคนไหนก็เปลี่ยนได้",
    joinCodeLabel: "รหัสเข้าสังกัด",
    copyCode: "คัดลอกรหัส",
    copyCodeCopied: "คัดลอกแล้ว",
    membersTitle: "สมาชิก",
    membersCount: "{count} คน",
    addMemberLabel: "อีเมลช่างภาพที่จะเพิ่ม",
    addMemberSubmit: "เพิ่มสมาชิก",
    addMemberErrorInvalid: "กรอกอีเมลให้ถูกต้อง",
    addMemberErrorNotFound: "ไม่พบช่างภาพที่ใช้อีเมลนี้",
    addMemberErrorNotApproved: "บัญชีนี้ยังไม่ได้รับอนุมัติเป็นช่างภาพ",
    addMemberErrorAlreadyIn: "ช่างภาพคนนี้อยู่ในสังกัดอื่นอยู่แล้ว",
    removeMember: "นำออก",
    removeMemberConfirm: "นำสมาชิกคนนี้ออกจากสังกัด?",
    leaveAffiliation: "ออกจากสังกัด",
    leaveConfirm: "ออกจากสตูดิโอสังกัดนี้? คุณจะยังจัดการงานส่วนตัวของตัวเองได้ตามปกติ",
    notInTitle: "คุณยังไม่ได้อยู่ในสังกัดใด",
    notInBody: "ขอรหัสเข้าสังกัดจากแอดมินหรือสมาชิกในสังกัดนั้น แล้วกรอกด้านล่างเพื่อเข้าร่วม",
    joinLabel: "รหัสเข้าสังกัด",
    joinSubmit: "เข้าร่วมสังกัด",
  ...
  adminAffiliationsPage: {
    title: "จัดการสังกัด",
    lede: "สร้างสังกัดแล้วให้รหัสเข้ากับช่างภาพที่ต้องการเข้าร่วม สมาชิกในสังกัดจะจัดการงานและสมาชิกร่วมกันได้เอง",
    createTitle: "สร้างสังกัดใหม่",
    createNameLabel: "ชื่อสังกัด",
    createEmailLabel: "อีเมลช่างภาพผู้ก่อตั้ง",
    createEmailHint: "ต้องเป็นช่างภาพที่ได้รับอนุมัติแล้ว และยังไม่ได้อยู่ในสังกัดอื่น",
    createChecking: "กำลังตรวจสอบ…",
    createSubmit: "สร้างสังกัด",
    createErrorInvalid: "กรอกชื่อสังกัดและอีเมลให้ถูกต้อง",
    createErrorEmailNotFound: "ไม่พบช่างภาพที่ใช้อีเมลนี้",
    createErrorEmailNotApproved: "บัญชีนี้ยังไม่ได้รับอนุมัติเป็นช่างภาพ",
    createErrorEmailAlreadyIn: "ช่างภาพคนนี้อยู่ในสังกัดอื่นอยู่แล้ว",
    empty: "ยังไม่มีสังกัดในระบบ",
    count: "{count} สังกัด",
    searchLabel: "ค้นหาด้วยชื่อสังกัด",
    searchPlaceholder: "พิมพ์ชื่อสังกัด…",
    searchEmpty: "ไม่พบสังกัดที่ตรงกับ \"{query}\"",
    joinCodeLabel: "รหัสเข้าสังกัด",
    memberCount: "{count} สมาชิก",
    createdAt: "สร้างเมื่อ",
    deleteButton: "ลบสังกัด",
    deleteConfirm: "ลบสังกัดนี้? สมาชิกและงานที่เคยอยู่ในสังกัดจะกลายเป็นอิสระ ไม่ถูกลบไปด้วย",
  },
...
export const en: Dictionary = {
  ...
  studio: {
    ...
    personSearchLabel: "Search this list",
    personSearchPlaceholder: "Search a name…",
    personSearchEmpty: 'No name matches "{query}"',
  ...
  admin: {
    ...
    reviewSearchPlaceholder: "Type a name…",
    reviewSearchEmpty: 'No items match "{query}"',
    approve: "Approve",
    reject: "Reject",
  ...
  affiliationsPage: {
    ...
    createdLabel: "Founded {date}",
    membersEmpty: "No members in this affiliation yet",
  },

  affiliationStudio: {
    title: "Affiliation studio",
    lede: "Events created in this studio are fully shared — every member of this affiliation can manage them.",
    settingsTitle: "Affiliation settings",
    renameLabel: "Affiliation name",
    renameSubmit: "Save",
    renameErrorInvalid: "Enter a valid affiliation name",
    renameErrorImageTooLarge: "That image is too large (5 MB max)",
    renameErrorImageBadFormat: "Only JPEG, PNG, or WebP files are supported",
    imageLabel: "Affiliation picture",
    imageChoose: "Choose picture",
    imageHint: "Any member of the affiliation can change this.",
    joinCodeLabel: "Join code",
    copyCode: "Copy code",
    copyCodeCopied: "Copied",
    membersTitle: "Members",
    membersCount: "{count} people",
    addMemberLabel: "Photographer's email to add",
    addMemberSubmit: "Add member",
    addMemberErrorInvalid: "Enter a valid email address",
    addMemberErrorNotFound: "No photographer found with that email",
    addMemberErrorNotApproved: "That account is not an approved photographer yet",
    addMemberErrorAlreadyIn: "That photographer already belongs to another affiliation",
    removeMember: "Remove",
    removeMemberConfirm: "Remove this member from the affiliation?",
    leaveAffiliation: "Leave affiliation",
    leaveConfirm: "Leave this affiliation studio? You can still manage your own personal events as usual.",
    notInTitle: "You are not in an affiliation yet",
    notInBody: "Ask an admin or a current member for a join code, then enter it below.",
    joinLabel: "Join code",
    joinSubmit: "Join affiliation",
  ...
  adminAffiliationsPage: {
    ...
    lede: "Create an affiliation and hand its join code to whoever should join. Members manage their own events and roster from there on.",
    createTitle: "Create a new affiliation",
    createNameLabel: "Affiliation name",
    createEmailLabel: "Founding photographer's email",
    createEmailHint: "Must be an approved photographer who is not already in another affiliation.",
    createChecking: "Checking…",
    createSubmit: "Create affiliation",
    createErrorInvalid: "Enter a valid affiliation name and email",
    createErrorEmailNotFound: "No photographer found with that email",
    createErrorEmailNotApproved: "That account is not an approved photographer yet",
    createErrorEmailAlreadyIn: "That photographer already belongs to another affiliation",
    empty: "No affiliations yet",
    count: "{count} affiliations",
    searchLabel: "Search by affiliation name",
    searchPlaceholder: "Type an affiliation name…",
    searchEmpty: 'No affiliation matches "{query}"',
    joinCodeLabel: "Join code",
    memberCount: "{count} members",
    createdAt: "Created",
    deleteButton: "Delete affiliation",
    deleteConfirm: "Delete this affiliation? Its members and events become independent rather than being deleted.",
  },
